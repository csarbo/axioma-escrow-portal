  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        navy: { DEFAULT: "hsl(var(--navy))", light: "hsl(var(--navy-light))", lighter: "hsl(var(--navy-lighter))" },
        status: {
          draft: "hsl(var(--status-draft))",
          awaiting: "hsl(var(--status-awaiting))",
          funding: "hsl(var(--status-funding))",
          escrow: "hsl(var(--status-escrow))",
          dispute: "hsl(var(--status-dispute))",
          arbitration: "hsl(var(--status-arbitration))",
